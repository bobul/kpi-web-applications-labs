...
export default function Page() {
  return (
    <main className="h-screen grid grid-rows-4 grid-cols-6">
      <div className="row-span-1 col-span-6 bg-teal-200 flex justify-around items-center">
      ...
      <div className="row-span-2 col-span-4 grid grid-rows-2 grid-cols-5">
        <div className="grid row-span-4 col-span-2">
          <div className="bg-teal-300 border border-t-0 border-r-0 border-l-0 overflow-auto">
          ...
          <div className="bg-teal-300 overflow-auto">
            <h1 className="font-bold text-gray-50 md:text-xl text-xs p-2">
        ...
        <div className="row-span-2 col-start-3 col-span-3 bg-blue-600 bg-teal-400 overflow-auto">
      ...
      <div className="row-span-4 col-start-5 col-span-2 overflow-auto bg-teal-300">
      ...
      <div className="row-span-1 col-span-4 bg-teal-200">
